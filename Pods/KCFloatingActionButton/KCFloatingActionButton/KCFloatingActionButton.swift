...
public class KCFloatingActionButton: UIView {
    ...
    */
    private var plusLayer: UIImageView = UIImageView.init()
...
//                self.plusLayer.frame = CGRectMake(0, 0, self.size, self.size)
                self.plusLayer.layer.transform = CATransform3DMakeRotation(self.degreesToRadians(-45), 0.0, 0.0, 1.0)
    ...
    public func close() {
        UIView.animateWithDuration(0.3, delay: 0,
            ...
            options: [], animations: { () -> Void in
                self.plusLayer.layer.transform = CATransform3DMakeRotation(self.degreesToRadians(0), 0.0, 0.0, 1.0)
...
//                    item.layer.transform = CATransform3DMakeScale(0.4, 0.4, 1)
    ...
    */
    ...
    private func setPlusLayer() {
        plusLayer.layer.removeFromSuperlayer()
        plusLayer.frame = CGRectMake(0, 0, size/2, size/2)
        plusLayer.image = UIImage.init(named: "Image")
        plusLayer.center = CGPointMake(size/2, size/2)

        layer.addSublayer(plusLayer.layer)
    }
    
    private func setTintLayer() {
        self.plusLayer.layer.removeFromSuperlayer()
        ...
        layer.addSublayer(self.plusLayer.layer)
...
//            
//        }
//        self.plusLayer.frame = CGRectMake(14, 14, 28, 28)
//        print(self.plusLayer.frame)
        overlayLayer.frame = CGRectMake(
            -UIScreen.mainScreen().bounds.width+(UIScreen.mainScreen().bounds.width-frame.origin.x),
            -UIScreen.mainScreen().bounds.height+(UIScreen.mainScreen().bounds.height-frame.origin.y),
            UIScreen.mainScreen().bounds.width,
